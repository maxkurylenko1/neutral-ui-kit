    ...
    <DropdownMenu>
      ...
      <DropdownMenuContent className="w-56">
        ...
        <DropdownMenuItem disabled>
          ...
          <span>Add to favorites (disabled)</span>
        </DropdownMenuItem>
      </DropdownMenuContent>
    </DropdownMenu>
  ),
...
export const ContextMenu = {
  render: () => (
    <div className="flex h-[150px] w-[300px] items-center justify-center rounded-md border border-dashed text-sm">
      <DropdownMenu>
        <DropdownMenuTrigger asChild>
          <button className="rounded-md px-4 py-2 text-sm font-normal transition-colors hover:bg-accent">
            Right click here
          </button>
        </DropdownMenuTrigger>
        <DropdownMenuContent>
  ...
  render: () => (
    <div className="space-y-4">
      <p className="text-sm text-muted-foreground">
        Open menu and use Arrow keys, Enter, and Esc
      </p>
      <DropdownMenu>
        <DropdownMenuTrigger asChild>
          <Button variant="outline">Open Menu</Button>
